 ...
 * @param {String} change 
 */
let writeExcel = async(filePath, searchText, replaceText, change)=> {
    ...
    let output = await readExcel(worksheet, searchText, change);
 ...
 * @returns {Object}
 */
let readExcel = async(worksheet, searchText) => {
